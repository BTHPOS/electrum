...
class AmountEdit(MyLineEdit):
    ...
    def __init__(self, base_unit, is_int = False, parent=None):
        ...
        # This seems sufficient for hundred-BTH amounts with 8 decimals
...
class BTHAmountEdit(AmountEdit):
...
class FeerateEdit(BTHAmountEdit):
    def _base_unit(self):
        return 'sat/byte'

    def get_amount(self):
        sat_per_byte_amount = BTHAmountEdit.get_amount(self)
