...
# (str) Package name
package.name = ElectrumBTH

# (str) Package domain (needed for android/ios packaging)
package.domain = org.electrumbth
...
presplash.filename = %(source.dir)s/icons/electrumbth_presplash.png

# (str) Icon of the application
icon.filename = %(source.dir)s/icons/electrumbth_launcher.png
...
android.add_activities = org.electrumbth.qr.SimpleScannerActivity
