...
class ElectrumWindow(App):
    ...
    def _get_bu(self):
        return self.electrum_config.get('base_unit', 'BTH')
    ...
    def on_qr(self, data):
        ...
        if is_address(data):
            self.set_URI(data)
            return
        if data.startswith('bithereumnetwork:'):
            self.set_URI(data)
            return
    ...
    def on_start(self):
        ...
        # bind intent for bithereumnetwork: URI scheme
        if platform == 'android':
            from android import activity
            from jnius import autoclass
            PythonActivity = autoclass('org.kivy.android.PythonActivity')
    ...
    def init_ui(self):
        ...
        self.icon = "icons/electrumbth.png"
