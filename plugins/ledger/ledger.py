...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Bithereum" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise BaseException(_("Device not in Bithereum mode")) from e
                raise e
